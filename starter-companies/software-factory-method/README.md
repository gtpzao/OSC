...
This copy is bundled inside OSC App and ships with `claude_local + fcc-claude + NVIDIA NIM` defaults so a new install can start without paid API subscriptions.
