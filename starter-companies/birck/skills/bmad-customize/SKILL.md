...
metadata:
  paperclip:
    slug: "bmad-customize"
    skillKey: "bmad-customize"
  paperclipSkillKey: "bmad-customize"
  skillKey: "bmad-customize"
key: "bmad-customize"
---
...
```
py {skill-root}/scripts/list_customizable_skills.py --project-root {project-root}
```
...
4. Verify:
   ```
   py {project-root}/_bmad/scripts/resolve_customization.py --skill <install-path> --key <agent-or-workflow>
   ```
