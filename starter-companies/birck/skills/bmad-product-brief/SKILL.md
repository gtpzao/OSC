...
slug: "bmad-product-brief"
metadata:
  paperclip:
    slug: "bmad-product-brief"
    skillKey: "bmad-product-brief"
  paperclipSkillKey: "bmad-product-brief"
  skillKey: "bmad-product-brief"
key: "bmad-product-brief"
---
...
1. Resolve customization: `py {project-root}/_bmad/scripts/resolve_customization.py --skill {skill-root} --key workflow`. On failure, read `{skill-root}/customize.toml` directly and use defaults.
