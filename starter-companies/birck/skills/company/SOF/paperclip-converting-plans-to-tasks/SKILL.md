...
metadata:
  paperclip:
    slug: "paperclip-converting-plans-to-tasks"
    skillKey: "paperclip-converting-plans-to-tasks"
  paperclipSkillKey: "paperclip-converting-plans-to-tasks"
  skillKey: "paperclip-converting-plans-to-tasks"
key: "paperclip-converting-plans-to-tasks"
---

# Paperclip Ã¢â‚¬â€ Converting Plans to Tasks

A companion skill for turning a plan into executable Paperclip work. It does **not** dictate a plan structure Ã¢â‚¬â€ bring whatever format fits the work and the user's preference. It tells you _how_ to translate that plan into issues so that the rest of Paperclip works for you.
...
- **Plan deeply.** Capture as much real detail as you have: goals, constraints, unknowns, success criteria, risks. A shallow plan becomes rework downstream Ã¢â‚¬â€ assignees can only act on what they can read.
...
- **Assign for specialty.** Hand each piece of work to the agent most relevant to it. If no one fits, call that out Ã¢â‚¬â€ a hire, a tool, an external dependency, a board decision Ã¢â‚¬â€ instead of papering over the gap.
...
- **Enough is enough.** Plans exist to unblock execution, not replace it. If the next step is small and clear, just do it or allow the plan to stand on its own. Re-planning a plan, or splitting work that one agent could finish in the time it took to break it up, is procrastination Ã¢â‚¬â€ ship something.
...
- [ ] Each issue has a deliberate, specialty-matched assignee Ã¢â‚¬â€ not the planner by default.
...
- Not a plan template. Use any format Ã¢â‚¬â€ prose, outline, table, RACI, Gantt, whatever fits.
- Not software-developmentÃ¢â‚¬â€œspecific. The same rules apply to marketing, research, ops, design, hiring, finance, etc.
