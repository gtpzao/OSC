...
slug: "bmad-advanced-elicitation"
metadata:
  paperclip:
    slug: "bmad-advanced-elicitation"
    skillKey: "bmad-advanced-elicitation"
  paperclipSkillKey: "bmad-advanced-elicitation"
  skillKey: "bmad-advanced-elicitation"
...
```bash
py {project-root}/_bmad/scripts/resolve_config.py --project-root {project-root} --key agents
```
