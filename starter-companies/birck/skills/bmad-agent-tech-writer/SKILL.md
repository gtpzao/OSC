...
metadata:
  paperclip:
    slug: "bmad-agent-tech-writer"
    skillKey: "bmad-agent-tech-writer"
  paperclipSkillKey: "bmad-agent-tech-writer"
  skillKey: "bmad-agent-tech-writer"
key: "bmad-agent-tech-writer"
---
...
Run: `py {project-root}/_bmad/scripts/resolve_customization.py --skill {skill-root} --key agent`
