...
export function Sidebar() {
  ...
  return (
    <aside className="relative w-full h-full min-h-0 overflow-hidden border-r border-sidebar-border bg-[radial-gradient(circle_at_top,_rgba(196,255,103,0.14),_transparent_34%),linear-gradient(180deg,_rgba(255,159,47,0.08),_transparent_24%),var(--color-sidebar)] backdrop-blur-xl flex flex-col">
      {/* Top bar: Company name (bold) + Search — aligned with top sections (no visible border) */}
      <div className="flex items-center gap-1 px-3 h-12 shrink-0 border-b border-sidebar-border/70">
        <SidebarCompanyMenu />
