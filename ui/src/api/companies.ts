...
export interface StarterCompanyInstallRequest {
  starterId: string;
  adapterType: string;
...
export const companiesApi = {
  ...
  installStarter: (
    companyId: string,
    data: StarterCompanyInstallRequest,
  ) => {
    const { starterId, ...body } = data;
    return api.post<CompanyPortabilityImportResult>(
      `/companies/${companyId}/starters/${starterId}/install`,
      body,
    );
  },
};
